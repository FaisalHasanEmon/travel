...
//         <div className="w-20 h-20 rounded-full bg-pink-200 flex items-center justify-center overflow-hidden flex-shrink-0">
//           <img
//             src={user?.photoURL}
//             alt="Profile"
...
//                 className="text-xl font-semibold text-gray-900 bg-transparent border-b border-gray-300 focus:border-blue-500 outline-none py-1"
...
//                 className="text-gray-600 bg-transparent border-b border-gray-300 focus:border-blue-500 outline-none py-1 block"
//                 placeholder="Email"
//               />
//               <p className="text-gray-500 text-sm">{profileData.joinDate}</p>
//             </div>
