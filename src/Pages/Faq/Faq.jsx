...
//           <div
//             key={index}
//             className="border-b-[1px] border-black  overflow-hidden"
//           >
//             <button
//               onClick={() => toggleItem(index)}
//               className="w-full px-6 py-4 text-left  flex justify-between items-center"
//             >
//               <span className="text-lg font-medium text-[#103928] pr-4">
//                 {item.question}
//               </span>
...
//                 <p className="text-[#4F5B67] leading-relaxed">{item.answer}</p>
//               </div>
//             </div>
//           </div>
//         ))}
